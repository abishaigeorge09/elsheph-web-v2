    ...
    <section id="hero" className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 lg:px-12 text-center">
        ...
        <a
          ...
          className={`inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 text-white/80 text-xs font-medium tracking-wider uppercase mb-8 hover:bg-white/15 hover:text-white/90 transition-all duration-300 delay-200 ${
        ...
        <a
          ...
          className={`md:hidden inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-semibold bg-[#8B6F47] text-white hover:bg-[#6B5230] transition-all duration-200 shadow-lg shadow-[#8B6F47]/20 delay-700 ${
