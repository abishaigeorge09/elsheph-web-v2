...
export default function Services() {
  const services = [
    ...
    {
      title: "IT Staffing",
      description: "Skilled engineers for short-term and long-term placements. We provide talent for product and platform teams, matched to your specific requirements.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Corporate L&D",
      description: "Technical training programs and product development workshops. Execution-focused learning with startup mindset enablement for enterprise teams.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
