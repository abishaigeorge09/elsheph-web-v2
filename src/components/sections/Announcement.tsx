    ...
    <section className="relative bg-gradient-to-b from-[#FAFAF7] to-white py-40 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-8 lg:px-12 text-center">
        ...
        <ScrollAnimation delay={300}>
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-black/5 border border-black/10 mb-12 hover:bg-black/10 transition-colors duration-300">
            <svg className="w-4 h-4 text-[#8B6F47]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <p className="text-sm font-medium text-black/70">
              Launching December 24
            </p>
          </div>
        </ScrollAnimation>
